...
import (
	...
	"devops.aishu.cn/AISHUDevOps/DIP/_git/agent-operator-integration/server/driveradapters/category"
	"devops.aishu.cn/AISHUDevOps/DIP/_git/agent-operator-integration/server/driveradapters/operator"
